...
```
infra-automation/
├── .github/workflows/        # CI/CD pipelines for different environments
├── helm/                     # Helm charts for K8s resources and GKE configuration
├── terraform/                # Terraform modules and environment configurations
├── scripts/                  # Utility scripts for validation and testing
├── tests/                    # Test cases for infrastructure validation
